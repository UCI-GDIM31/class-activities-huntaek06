...
public class SoccerBall : MonoBehaviour
{
    ...
    private int _points = 0;
        // STEP 5 -----------------------------------------------------------------
        // Increase the points variable by 1.

        // Update the _pointsText to show the new points value.
    ...
    {
        // STEP 6 -----------------------------------------------------------------
        // Increase your time variable by the time passed since last frame.
        _timeSinceLastGoal += Time.deltaTime;

        // Update the _timeText to show the new time value.
